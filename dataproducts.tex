...
\tablecaption{The Parameters From Eqs.~\ref{ggg} and \ref{m5} {\bf XXX will be updated!}\label{tab:eqparams}}
\tablehead{
\colhead{} & \colhead{$u$}  &   \colhead{$g$}   & \colhead{$r$}   &  \colhead{$i$}  & \colhead{$z$}  & \colhead{$y$}
}
\startdata
   $m_{\rm sky}$\tablenotemark{a} &   22.9    & 22.3    & 21.2    & 20.5    & 19.6    &  18.6  \\
...
SDSS experience (\cite{2007AJ....134.2236S}), the random photometric error for
point sources, as
...
activity (which influences the night sky brightness, \cite{2008A&A...481..575P}) is about
0.1-0.2 mag.
...
described in \cite{2017arXiv171110621J}, \cite{2017AJ....154...12V,2017AJ....154...13V}, and \cite{2016AJ....151..172G}.
...
Here we briefly summarize the LSST project analysis carried out in \cite{2017arXiv171110621J}; this
...
System model of of \cite{2007AAS...211.4721G}.
...
spectra (\cite{2009Icar..202..160D}), combined with the LSST bandpasses (listed in Table~\ref{tab:eqparams}),
...
Object Processing System (MOPS) code (\cite{2017AJ....154...12V,2017AJ....154...13V}; \cite{2005AAS...20712102J}) developed by the
...
$>$99\% linking efficiency across all classes of Solar System objects (\cite{2013PASP..125..357D}),
and at least 93\% efficiency for NEOs (\cite{2017AJ....154...12V,2017AJ....154...13V}).

The LSST baseline cadence discovers 66\% of PHAs with $H\leq22$ (equivalent to $D\ge140$~m)
after 10 years of operations (61\% of NEOs with $H\leq22$) (\cite{2017arXiv171110621J}).  This cadence spends 6\% of the total
...
code; results reported by DES (\cite{DES}) indicate astrometric residuals of $\sim 7$mas for 30s exposures
...
effects) at the level of 20-30 mas (measured from repeated scans; \cite{2003AJ....125.1559P});
...
techniques developed at the U.S. Naval Observatory (\cite{2003AJ....125..984M}). The expected
proper motion and
...
accuracy of $\sim$5 mas yr$^{-1}$ per coordinate at $r=20$ (\cite{2004AJ....127.3034M}). Gaia
is expected to deliver parallax errors of 0.3 mas and proper motion errors of
0.2 mas yr$^{-1}$ at its faint end at $r\sim20$ (\cite{2001A&A...369..339P}). Hence, LSST will smoothly
...
Data Products Definition Document (\cite{LSE-163}).
...
data-intensive astronomy (\cite{Tyson2008b}; \cite{2008AIPC.1082..359I};
\cite{2008AN....329..284B}; \cite{2008AN....329..255B}; \cite{2014sdmm.book.....I}). To address these questions, the statistics and machine-learning research
...
colorized following \cite{2004PASP..116..133L}.  The depth gain for the bottom image
...
\cite{2007AJ....133..214M}); the bottom image was taken with Suprime-cam at Subaru.
Adapted from \cite{2007AAS...21113707B}.}
\label{Fig:panels2}
\end{figure}
