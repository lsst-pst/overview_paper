...
\tablenotetext{^b}{The expected delivered median zenith seeing
  (arcsec). The seeing scales with airmass, $X$, as $X^{0.6}$.}
...
\citep[e.g.,]{Tyson2008,2008AIPC.1082..359I,2008AN....329..284B,2008AN....329..255B,2014sdmm.book.....I}.
To address these challenges, the statistics and machine-learning research
...
\item Rapid characterizations and probabilistic classifications for
  the several million sources
          detected in difference images (``alerts'') each night.
...
\item Application of dimensionality-reduction techniques to determine important physical correlations
