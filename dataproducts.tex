...
\begin{itemize}
\item {\bf   Prompt products (Level 1)}, designed to support the discovery,
...
prompt and data release  products, a limited number of highly specialized
...
LSST Large Data Facility, given the size of the LSST data set and the
...
of {\bf added value} (user-created) data products. It will also allow the
