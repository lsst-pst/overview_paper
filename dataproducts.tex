...
described in Jones et al.~(2017), Vere{\v s} \& Chesley~(2017b), and Grav et al.~(2016).
...
window of 15 days, with a minimum of two visits per night. The same criteria has been used in NASA studies,
and is confirmed as reliable by a detailed analysis of orbital linking and orbit determination using the Moving
Object Processing System (MOPS) code (Vere{\v s} \& Chesley~2017b; Jedicke et al.~2005) developed by the 
...
and at least 93\% efficiency for NEOs (Vere{\v s} \& Chesley~2017b).  
...
\begin{figure}
\includegraphics[width=1.0\hsize,clip]{neo_pha_completeness_3in15_minion_1016}
\includegraphics[width=1.0\hsize,clip]{neo_pha_completeness_3in30_astro_lsst_01_1016}
...
lower panel of Fig.~\ref{Fig:Cneo}). 
