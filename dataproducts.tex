...
gathered by projects such as the JHU SciServer, Gaia GAVIP, and NOAO
Datalab.
...
\item The {\bf JupyterLab} aspect, that will provide a Jupyter Notebook-like
...
applications that the users are already comfortable with (eg., such as
TOPCAT, or libraries such as AstroPy).  Furthermore, the offered APIs will allow
