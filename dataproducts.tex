...
accuracy of $\sim$5 mas yr$^{-1}$ per coordinate at $r=20$ \citep{2004AJ....127.3034M}. 

% LPG issue 48 
% Original text
% Gaia is expected to deliver parallax errors of 0.3 mas and proper motion errors of
% 0.2 mas yr$^{-1}$ at its faint end at $r\sim20$ \citep{2001A&A...369..339P}. 
 
\newtext{Gaia DR2 has delivered a median uncertainty in parallax of 0.1 mas  
and in proper motion of  0.2 mas yr$^{-1}$ at its faint end,  corresponding to $r\sim20$ 
\citep{2018A&A...616A...1G,2018A&A...616A...2L}.
This is considerably better than the pre-mission simulation-based prediction of 0.3 mas for parallax and 
roughly equal to that for proper motion \citep{2001A&A...369..339P}. 
}
Hence, LSST will smoothly extend Gaia's error vs.\ magnitude curve 4 magnitudes fainter.
(for illustration, see fig.~21 in \citealt{2012ARA&A..50..251I}).

% New figures still to be completed
% Figure XX illustrates this synergy between LSST and Gaia. (add in new figure with Gaia DR2 curves instead of pre-mission predictions.
