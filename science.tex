...
event timescale (adapted from Kulkarni et al.~2007 and Kasliwal et al.~2011). LSST will open up large 
regions of this phase space for systematic exploration by extending
time-volume space over 100 times over existing surveys.} 
\label{Fig:shri}
\end{figure}
...
\item Studies of stellar eruptions, known generally as luminous blue variable (LBV) both through pre-eruption characterization of sources at the positions of eruptive transients in the ​deep LSST ​stacks​ and detection of faint precursor eruptions, and by constraining rates of individual ​LBV-like eruption ​subclasses​ (Smith 2014)​​.​
...
\item Studies of known and unusual SN populations and parameterization of their light curves (e.g., Hoeflich, Wheeler \& Thielemann~1998; Wang et al.~2003; Howell et al.~2007; Kowalski et al.~2008; Hicken et al.~2009; Foley~2012​, Bianco et al.~2014, Arcavi~2017​).

\item A deep search for new populations of novae and supernova progenitors 
      (Smartt 2009; Thompson et al.~2009; Smith et al.~2011; see Fig.\ref{Fig:shri}) both through direct imaging and through the detection of SN precursor events (Ofek et al.~2013).

\item The discovery of multiply imaged lensed SNe (expected 500 multiply image SN Ia)
...
\item Optical identification for transients and variables detected in
  ...
  also help illuminate the nature of the still-mysterious Lorimer
  Bursts (Lorimer et al.~2007; Thornton et al.~2013).
...
\item Optical identification of counterparts to non-electromagnetic
  ...
  (LIGO\footnote{http://www.ligo.caltech.edu}, ICECUBE\footnote{http://icecube.wisc.edu}).  
LSST’s unique ability to characterize the
  faint variable sky over large areas will be important for the
  detection of associated sources, with an estimate of $\sim 7$
  discoveries per year (Scolnic et al. 2017). The power of the Advanced LIGO\footnote{https://www.advancedligo.mit.edu/}
  (aLIGO)/Virgo experiment lead to the discovery of four GW events in
  less than a year. The latest, GW170817, a neutron star-neutron star
  merged, was accompanied by an electromagnetic counterpart,
  kilonova SSS17a, which was observed in the optical wavelengths (Coulter et
  al.~2017; Drout et al.~2017; Soares-Santos et al.~2017; Valenti et al.~2017). Its
  electromagnetic evolution was somewhat unexpected.  The ~100
  kilonovae sample that LSST is expected to generate will enable
  comparative studies of these transients. LSST will also be important
  for eliminating potential false positives (Nissanke, Kasliwal \&
  Georgieva 2013; Metzger \& Berger 2012).
