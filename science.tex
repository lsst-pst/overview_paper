...
\item The discovery of strongly lensed SNe; $500-1000$ multiply imaged SN~Ia are expected to be discovered by LSST (Goldstein \& Nugent~2017; Goldstein et al.~2017), and at least several hundred strongly lensed core-collapse SNe. 
  Time delays between the multiple images of strongly lensed core-collapse SNe can be used to observe the elusive shock breakout phase of the light curve, providing an unprecedented look at the early emission from SNe (Suwa 2017). 
