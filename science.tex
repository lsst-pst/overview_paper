...
magnitude (from 30 sec to 10 years), and produce roughly \textit{forty
  trillion
...
The LSST sample of asteroids with accurate orbits will be 10 to 100
larger than currently available sample, all with detailed color and
variability information.  LSST will make a significant contribution the Congressional target
...
\citet{2006Sci...312..561H}); such objects will appear extended in the
...
The optical/NIR emission had two distinct components, blue emission
...
and its remnant.
  LSST
  will also be important for identifying the optical transient
  corresponding to a LIGO event in the first place, eliminating potential false positives
...
\item The first wide field survey of ultra low surface brightness galaxies, with
      ...
      samples (e.g., \citet{2017arXiv170904474G}) are highly
