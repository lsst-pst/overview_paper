...
% $l< 100$, and intrinsic ellipticities which dominate at $l> 1000$ (\cite{2006JCAP...08..008Z}).}
% \label{Fig:wlPk}
% \end{figure}
...
%oscillations (\cite{2005ApJ...633..560E}; \cite{2005MNRAS.362..505C}; \cite{2014MNRAS.441...24A}). LSST will measure the
%angular diameter distance over this redshift range with an accuracy of $\sim1$\%
%(\cite{2006ApJ...644..663Z}).}
%\label{Fig:bao}
%\end{figure}
...
%result based on WMAP and SDSS data (\cite{2009ApJS..180..330K}; \cite{2010MNRAS.401.2148P}).
...
\cite{2011PhRvD..83d3004B}, \cite{2017ApJ...847..128H}), weak lensing of supernova brightnesses (\cite{2006PhRvD..74f3515D},
\cite{2014PhRvD..89b3009Q}, \cite{Macaulay2016}, \cite{Scovacricchi2017}), and the local bulk flow (\cite{Reiss1999},
\cite{2011JCAP...04..015D}, \cite{2012MNRAS.420..447T}, \cite{2013A&A...560A..90F},  \cite{2015JCAP...12..033H}) as well as
low redshift constraints on the isotropy of the universe (\cite{Javanmardi2015}, \cite{ 2010JCAP...12..012A},
...
For example, WL$+$LSS and SN can separately probe anisotropy of dark energy (e.g. \cite{2009ApJ...690..923Z}).
...
of 0.04 eV or better (\cite{1999A&A...348...31C}; \cite{2004PhRvD..70f3510S}; \cite{2006JCAP...06..025H}).
...
%constraint on dark energy (\cite{2005astro.ph.12513W}). LSST will find over 200,000 such
...
%          (e.g., \cite{2000ApJ...529L..45C}; \cite{Konacki2003}).
