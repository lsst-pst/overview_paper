...
photometric redshifts with an accuracy ($\sigma/(1+z)$) of 1-2\%; the
sample to this limit will include several billion galaxies.  At a
...
diagnostic of the underlying cosmology (Choi et al.~2012). The combination with the
...
Dai et al. 2011, Turnbull et al. 2012, Feindt et al. 2013,  Huterer et al. 2015, ) as well as the 
low redshift constraints on isotropy of the universe (Javanmardi et al. 2015, Antoniou et al. 2010, 
...
redshift of 1.0, limited by the systematics related to the limits of our astropysical understanding of supernovae 
