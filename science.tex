...
\begin{figure}
%\includegraphics[width=1.0\hsize,clip]{DEellipses1}
%\includegraphics[width=0.95\hsize,clip]{DEellipses2}
...
\begin{itemize}
\item The \textsl{3$\times$2-point} joint analysis of shear--shear, galaxy--shear, and galaxy--galaxy
...
could probe General Relativity at high redshift \citep{2010Natur.464..256R}.
%
...
\citep{2000ASPC..201...80R,2011JCAP...04..015D,2012MNRAS.420..447T,2013A&A...560A..90F,2015JCAP...12..033H} as well as
low redshift constraints on the isotropy of the universe
...
completeness of 90\% for PHAs larger than 140\,m (\S~\ref{Sec:NEOc}), and will detect over 30,000
TNOs brighter than $r\sim24.5$ using its baseline cadence. LSST will be capable
...
\citealt{2006Sci...312..561H}),  due to mass loss with associated extended
...
limit; temporally resolved activity including coverage of transient events
time-scales \citep{1999A&A...349..649L,2004come.book...17A}.  LSST will
discover an unprecedentedly large number of comets with typically 50
observations per object spread throughout their orbit during the 10-year
...
1I/2017 U1 (`Oumuamua), discovered by Pan-STARRS1 \citep{2017MPEC....U..181B}, has shown the power  of large, complete all-sky surveys to unearth
...
\hskip -0.1in
\vskip -0.1in
%\includegraphics[width=1.1\hsize,clip]{shri2}
...
\caption{The phase space of cosmic explosive and eruptive transients
  ...
  Novae (MMRD) is as described in \citet{1995ApJ...452..704D}.  LSST
...
\item Optical identification of counterparts to non-electromagnetic
  ...
  of the Advanced LIGO (aLIGO)/Virgo\footnote{\url{http://public.virgo-gw.eu/language/en/}} experiment led to the discovery
  ...
  evolution of the kilonova was somewhat unexpected \citep{2017ApJ...848L..12A}.
...
\begin{figure}
%\includegraphics[width=1.0\hsize,clip]{smolcic}
%\hskip -1.0in
