...
\item Optical identification of counterparts to non-electromagnetic
  ...
  important for the detection of GW associated sources, with an
  estimate of $\sim 7$ discoveries per year (Scolnic et al. 2017).
  The power of the Advanced LIGO
  (aLIGO)/Virgo\footnote{http://public.virgo-gw.eu/language/en/}
  experiment led to the discovery of four GW events in less than a
  year. The binary neutron star merger event
  %GW170817 was accompanied
  %by emission detected across the entire electromagnetic spectrum
  %(Abbott et al.~2017).
  GW170817 was accompanied by emission
  detected across the entire electromagnetic spectrum (Abbott et
  al. 2017) with two distinct components: a blue emission (which peaked
  faded away on a time scale of a few days) and a redder component
  that persisted for $\sim15$ days arising from the radioactive decay of
  heavy elements synthesized during the NS merger, a ``kilonova''
  emission (SSS17a).
  %Multiple teams discovered bright UV/optical/NIR
  %emission arising from the radioactive decay of heavy elements
  %synthesized during the NS merger, a ``kilonova'' emission
  %(SSS17a).
  While both components of emission had been predicted
  (Metzeger 2016), the $\sim100$ kilonovae sample that LSST is expected to
  generate will enable comparative studies of these transients,
  allowing us to understand how the presence and relative luminosity
  of the two components varies to the properties of the binary system
  (e.g. mass) and its remnant.
  %The evolution of the kilonova was somewhat unexpected (Abbott et
  %al.~2017).  The ${\sim100}$ kilonovae sample that LSST is expected
  %to generate will enable comparative studies of these transients.
  LSST will also be important for identifying the optical transient
  corresponding to LIGO events in the first place, eliminating false
  positives (Nissanke, Kasliwal \& Georgieva 2013; Metzger \& Berger
  2012, Cowperthwaite \& Berger 2015; Coughlin et al. 2017).  At 24th
...
\bibitem[()]{} Abbott et al. 2017, Phys. Rev. Lett. 118, 221101.
...
\bibitem[()]{} Coughlin, M., et al.~2017,;  Astrophysical Journal, 849, 12.
...
\bibitem[()]{} Cowperthwaite, P. S. \& Berger, E.~2015, Astrophysical Journal, 814, 25.
...
\bibitem[()]{} Metzger, B.D., 2017 Living Rev Relativ  20: 3.
