...
The data collected by the LSST telescope and camera will be automatically reduced to scientifically useful catalogs and images by the LSST Data Management (DM) system (\S~{sec:dm}). The DM system will perform two, somewhat overlapping in scientific intent, types of image analyses:
