...
infrastructure\footnote{In addition to this allocation, the pipeline
  architecture enables Level 3 tasks to leverage contemporaneous Level
  2 processing.}. 
