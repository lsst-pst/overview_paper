...
in the $ugrizy$ bands, respectively. The listed values are expressed on AB magnitude scale, 
and correspond to point sources and fiducial zenith observations (about 0.2 mag loss of depth 
...
\hline
    $C_m^e$        &   23.05   & 24.40    & 24.60   & 24.22   & 23.92   & 23.17 \\
    $m_5^f$         &   23.9     &   25.0    & 24.7     &  24.0   & 23.3    & 22.1  \\
 $\Delta C^{\infty,g}_m$  &  0.38   &  0.15     &  0.08   &  0.06   &   0.04  &  0.03  \\ 
 $\Delta C_m(2)^h$       &  0.16   &  0.07     &   0.04  &  0.03   &   0.02  &  0.01 \\   
\hline
    $\Delta m_5^i$ &   0.21    & 0.15   & 0.14     &  0.13   & 0.13    & 0.15  \\
\hline                         
\end{tabular}
  \\ \vskip 0.05in
  \R{Entries for $C_m$, $m_5$, $\Delta C^{\infty}_m$ and $\Delta C_m(2)$ will be updated!} \\
  ...
  $^h$ Additive correction to $C_m$ when exposure time is doubled from its fiducial value 
          to 60 sec. \\
  $^i$ The loss of depth at the median airmass of $X=1.2$ due to seeing degradation 
...
seeing, 0.20 mag due to fainter sky, and \R{ FIX ME! 0.10 mag due to better throughput,
...
9 e$^-$ per pixel and per exposure, which has negligible effect on $m_5$ in all bands 
except for the $u$ band. This loss of depth due to instrumental noise, $\Delta C^{\infty}_m$,
