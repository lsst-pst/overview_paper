...
\begin{itemize}
\item Process, in real time, the incoming stream of images generated by the camera system during observing by archiving raw images, generating alerts to new sources or sources whose properties have changed, and updating the relevant catalogs (Nightly  products; \S~\ref{Sec:dp}).
...
All nightly and half the data release product processing will take place at the
