...
mass distribution (as probed by neutral hydrogen in CHIME (Newburgh et al.~2014), HIRAX (Newburgh et al. 2016) or SKA, or galaxies in DESI and PFS) with the gravitational growth
probed by tomographic shear in LSST will be complementary way to constrain dark energy
properties beyond simply characterizing its equation of state. Current and future ground-based CMB experiments, such as Advanced ACT (De Bernardis et al.~2016), SPT-3G (Benson et al.~2014) and CMB Stage-4 (Abazajian et al.~2016), will also offer invaluable opportunities for cross-correlations with secondary CMB anisotropies.
