...
%\includegraphics[width=1.55\hsize,angle=90.0,clip]{camera2009.pdf}
\hskip 0.1in
\includegraphics[width=0.45\textwidth]{CameraFigureUpdated2017.pdf}
...
that the source code is not only available, but apropriately documented at all
levels.
...
The LSST Softare Stack may be of interest and (re)used beyond the LSST project (e.g.,
