...
\url{https://www.lsst.org/main/lsst-aas} and further links at
\url{http://www.lsst.org/lsst/news}.}.
...
\citep{2007ApJ...659...98R,2009ApJS..180..330K,2010MNRAS.401.2148P,2012arXiv1211.0310L,2013arXiv1306.0913W}, and
...
X-ray emission; \citet{2013ApJ...765...24N} and \citet{2013MNRAS.430...81R}), dwarf satellite
...
baryon physics becomes important, and the nature of dark matter may manifest itself in observable ways \citep[e.g.][]{2013arXiv1306.0913W}.
...
accuracy should be 0.2 mas yr$^{-1}$ or better. This is the same accuracy as will be delivered by the recently launched Gaia mission\footnote{\url{http://sci.esa.int/gaia/}} \citep{2001A&A...369..339P,2012Ap&SS.341...31D} at its faint limit ($r \sim 20$).
...
\item  \textit{The single visit exposure time} (including both exposures in a
...
efficient survey strategy where \textit{a single dataset serves most science
...
We note that the Pan-STARRS project \citep{2002SPIE.4836..154K}, with similar science
...
Pan-STARRS is available from \url{http://pan-starrs.ifa.hawaii.edu}.}.
...
dotted line), optics, and the detector sensitivity. \textbf{XXX will be updated!}}
\label{Fig:filters}
\end{figure}
...
Fig.~\ref{Fig:modtran2}. Adapted from \citet{2007AAS...21113723B}.}
\label{Fig:modtran1}
\end{figure}
...
Adapted from \citet{2007AAS...21113723B}.}
\label{Fig:modtran2}
\end{figure}
...
in reality the LSST auxiliary telescope will take
...
This calibration process has been undertaken by the Dark Energy Survey (DES) team, with results reported in \citep{2017arXiv170601542B}).
...
\citep{2008ApJ...674.1217P,2012ApJ...756..158S,2017arXiv170601542B}, although measurements with ground-based telescopes
...
to monitor stability and uniformity of photometric data. We expect to use \citet{2016A&A...595A...2G} photometry, utilising
...
and 2009.  The primary-tertiary mirror was polished by the Richard F.Caris Mirror Lab at the University of Arizona Tucson before being inspected and accepted by LSST in April 2015 \citep{2016SPIE.9906E..0LA}. The  primary-tertiary mirror cell was fabricated by CAID in Tucson and is undergoing acceptance tests. The integration of the actuators and final tests with the mirror is scheduled later this fall and beginning of 2018.
...
\citet{2012arXiv1210.1616M}).  The telescope enclosure houses a compact, stiff
...
\item Periodically process the accumulated survey data to provide a
  ...
  properties of all detected objects, and characterize objects based on their time-dependent behavior. The results of such a processing run form a \emph{Data Release} (DR), which is a static, self-consistent data set suitable for use in performing scientific analyses of LSST data and publication of the results (the data release products; \S~\ref{Sec:dp}). All data releases will be archived for the entire operational life of the LSST archive.
...
\citet{2017arXiv170405858A,2017arXiv170506766B}; see Fig.~\ref{Fig:HSC_cosmos}).
...
and by stacking spectra from the SDSS
