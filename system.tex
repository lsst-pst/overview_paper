...
% LPG Issue 48 update to quote Gaia DR2 mission performance
% The original number of 0.2mas/yr at r ~ 20 was for G = 17  according to perryman et. al. 
%
% Original text
%This is the same accuracy as will be delivered by the 
% Gaia mission\footnote{\url{http://sci.esa.int/gaia/}} \citep{2001A&A...369..339P,2012Ap&SS.341...31D} at its faint limit ($r \sim 20$).

\newtext{
This is the comparable to the accuracy delivered by Gaia Data Release 2 (Gaia DR2)
for 1.3 billion sources of 0.05, 0.2, and 1.2 mas yr$^{-1}$ for G $<$14, G=17 ($r \sim 20$) and G=20 respectively
\citep{2018A&A...616A...1G,2018A&A...616A...2L},
and in line with early predictions of the mission performance of  
0.2 mas yr$^{-1}$  \citep{2001A&A...369..339P,2012Ap&SS.341...31D} . 
% Predictions based on the delivered Gaia DR2 performances indicate that Gaia DR3 will achieve XXXX - 
}
