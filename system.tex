...
More recently a pipeline derived from the present-day LSST software stack prototypes 
...
Most of the LSST software stack is free software, licensed under the terms of the GNU General
Public License, Version 3. The source code may be found at \url{https://github.com/lsst}.
The documentation for the LSST Science Pipelines components of the stack are available at
\url{http://pipelines.lsst.io}.
Its open source nature, attention to software engineering, a long-term
institutional commitment, and a modular design may make it of interest as
a basis for development of image processing pipelines for instruments 
beyond LSST.
